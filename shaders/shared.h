...
#define OM_OPTIMIZE_BIT 1
#define OM_AVERAGE_BIT 2
#define OM_CONDITIONAL_BIT 4

#define OM_OPTIMIZE (OM_OPTIMIZE_BIT)
#define OM_AVERAGE (OM_AVERAGE_BIT)
#define OM_HYBRID (OM_OPTIMIZE_BIT | OM_AVERAGE_BIT)
#define OM_COND_AVERAGE (OM_OPTIMIZE_BIT | OM_AVERAGE_BIT | OM_CONDITIONAL_BIT)
